...
import 'l_shipping_address_desktop_model.dart';
export 'l_shipping_address_desktop_model.dart';

class LShippingAddressDesktopWidget extends StatefulWidget {
  const LShippingAddressDesktopWidget({super.key});

  @override
  State<LShippingAddressDesktopWidget> createState() =>
      _LShippingAddressDesktopWidgetState();
}

class _LShippingAddressDesktopWidgetState
    extends State<LShippingAddressDesktopWidget> {
  late LShippingAddressDesktopModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LShippingAddressDesktopModel());
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: AddressCard3Widget(
                                ...
                                state: 'NY',
                                street: '88 Industrial Way, Suite 400',
                                zip: '11201',
                                isDefault: false,
                              ),
                            ),

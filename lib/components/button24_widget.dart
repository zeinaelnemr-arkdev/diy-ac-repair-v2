...
import 'button24_model.dart';
export 'button24_model.dart';

class Button24Widget extends StatefulWidget {
  const Button24Widget({
    super.key,
    String? content,
    this.icon,
    bool? icon_present,
  ...
  @override
  State<Button24Widget> createState() => _Button24WidgetState();
}

class _Button24WidgetState extends State<Button24Widget> {
  late Button24Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Button24Model());

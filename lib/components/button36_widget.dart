...
import 'button36_model.dart';
export 'button36_model.dart';

class Button36Widget extends StatefulWidget {
  const Button36Widget({
    super.key,
    String? content,
    this.icon,
    bool? iconPresent,
  ...
  @override
  State<Button36Widget> createState() => _Button36WidgetState();
}

class _Button36WidgetState extends State<Button36Widget> {
  late Button36Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Button36Model());

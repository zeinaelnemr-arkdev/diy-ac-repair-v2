...
import 'text_field15_model.dart';
export 'text_field15_model.dart';

class TextField15Widget extends StatefulWidget {
  const TextField15Widget({
    super.key,
    bool? label,
    bool? helper,
    String? hint,
  ...
  @override
  State<TextField15Widget> createState() => _TextField15WidgetState();
}

class _TextField15WidgetState extends State<TextField15Widget> {
  late TextField15Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextField15Model());

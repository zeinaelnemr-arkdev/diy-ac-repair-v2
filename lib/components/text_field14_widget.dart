...
import 'text_field14_model.dart';
export 'text_field14_model.dart';

class TextField14Widget extends StatefulWidget {
  const TextField14Widget({
    super.key,
    bool? label,
    bool? helper,
    String? hint,
  ...
  @override
  State<TextField14Widget> createState() => _TextField14WidgetState();
}

class _TextField14WidgetState extends State<TextField14Widget> {
  late TextField14Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextField14Model());

...
import 'text_field22_model.dart';
export 'text_field22_model.dart';

class TextField22Widget extends StatefulWidget {
  const TextField22Widget({
    super.key,
    String? label,
    bool? labelPresent,
    String? helper,
    ...
    bool? error,
        ...
        this.hint = hint ?? 'Search orders or parts',
        this.value = value ?? '',
  ...
  @override
  State<TextField22Widget> createState() => _TextField22WidgetState();
}

class _TextField22WidgetState extends State<TextField22Widget> {
  late TextField22Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextField22Model());

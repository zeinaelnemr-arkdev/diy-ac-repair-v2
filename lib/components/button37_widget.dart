...
import 'button37_model.dart';
export 'button37_model.dart';

class Button37Widget extends StatefulWidget {
  const Button37Widget({
    super.key,
    String? content,
    this.icon,
    bool? iconPresent,
    ...
    bool? loading,
    bool? disabled,
  })  : this.content = content ?? 'Try Again',
  ...
  @override
  State<Button37Widget> createState() => _Button37WidgetState();
}

class _Button37WidgetState extends State<Button37Widget> {
  late Button37Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Button37Model());

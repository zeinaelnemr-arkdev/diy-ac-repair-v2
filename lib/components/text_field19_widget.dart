...
import 'text_field19_model.dart';
export 'text_field19_model.dart';

class TextField19Widget extends StatefulWidget {
  const TextField19Widget({
    super.key,
    bool? label,
    bool? helper,
    String? hint,
    ...
    bool? error,
        ...
        this.hint = hint ?? 'Search order ID...',
        this.value = value ?? '',
  ...
  @override
  State<TextField19Widget> createState() => _TextField19WidgetState();
}

class _TextField19WidgetState extends State<TextField19Widget> {
  late TextField19Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextField19Model());

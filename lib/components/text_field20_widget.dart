...
import 'text_field20_model.dart';
export 'text_field20_model.dart';

class TextField20Widget extends StatefulWidget {
  const TextField20Widget({
    super.key,
    bool? label,
    bool? helper,
    String? hint,
  ...
  @override
  State<TextField20Widget> createState() => _TextField20WidgetState();
}

class _TextField20WidgetState extends State<TextField20Widget> {
  late TextField20Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextField20Model());

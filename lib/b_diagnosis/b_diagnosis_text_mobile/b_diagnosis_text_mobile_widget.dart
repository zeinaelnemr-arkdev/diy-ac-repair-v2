...
import 'b_diagnosis_text_mobile_model.dart';
export 'b_diagnosis_text_mobile_model.dart';

class BDiagnosisTextMobileWidget extends StatefulWidget {
  const BDiagnosisTextMobileWidget({super.key});

  @override
  State<BDiagnosisTextMobileWidget> createState() =>
      _BDiagnosisTextMobileWidgetState();
}

class _BDiagnosisTextMobileWidgetState
    extends State<BDiagnosisTextMobileWidget> {
  late BDiagnosisTextMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BDiagnosisTextMobileModel());

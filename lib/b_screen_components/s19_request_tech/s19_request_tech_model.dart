...
import 's19_request_tech_widget.dart' show S19RequestTechWidget;
import 'package:flutter/material.dart';

class S19RequestTechModel extends FlutterFlowModel<S19RequestTechWidget> {
  ...
  // State field(s) for TextField-Address widget.
  ...
  String? _textFieldAddressTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
  ...
  void initState(BuildContext context) {
    ...
    textFieldAddressTextControllerValidator =
        _textFieldAddressTextControllerValidator;
    textFieldSubjectTextControllerValidator =

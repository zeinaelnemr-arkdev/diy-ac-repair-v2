...
import 's17_filter_index_copy_widget.dart' show S17FilterIndexCopyWidget;
import 'package:flutter/material.dart';

class S17FilterIndexCopyModel
    extends FlutterFlowModel<S17FilterIndexCopyWidget> {
  ...
  // Model for Filter_All_parts component.
  late FilterAllPartsModel filterAllPartsModel;
  ...
  void initState(BuildContext context) {
    filterAllPartsModel = createModel(context, () => FilterAllPartsModel());
  }

  @override
  void dispose() {
    filterAllPartsModel.dispose();

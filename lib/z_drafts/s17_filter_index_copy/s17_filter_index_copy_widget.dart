...
import '/z_drafts/filter_all_parts/filter_all_parts_widget.dart';
import 'package:auto_size_text/auto_size_text.dart';
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';
import 's17_filter_index_copy_model.dart';
export 's17_filter_index_copy_model.dart';

class S17FilterIndexCopyWidget extends StatefulWidget {
  const S17FilterIndexCopyWidget({
    super.key,
    this.onPartSelected,
    required this.selectedPartParam,
  });
  ...
  @override
  State<S17FilterIndexCopyWidget> createState() =>
      _S17FilterIndexCopyWidgetState();
}

class _S17FilterIndexCopyWidgetState extends State<S17FilterIndexCopyWidget> {
  late S17FilterIndexCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => S17FilterIndexCopyModel());
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            wrapWithModel(
              model: _model.filterAllPartsModel,
              updateCallback: () => safeSetState(() {}),
              child: FilterAllPartsWidget(),
            ),
            Align(
              alignment: AlignmentDirectional(0.0, 0.0),
              child: Padding(
                                                                            ...
                                                                            Align(
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Align(
                                                                                  alignment: AlignmentDirectional(0.0, 0.0),
                                                                                  child: FlutterFlowDropDown<String>(
                                                                                    controller: _model.dropDownMakeValueController6 ??= FormFieldController<String>(
                                                                                      _model.dropDownMakeValue6 ??= '',
                                                                                    ),
                                                                                    options: List<String>.from(<String>[]),
                                                                                    optionLabels: <String>[],
                                                                                    onChanged: (val) => safeSetState(() => _model.dropDownMakeValue6 = val),
                                                                                    height: 24.5,
                                                                                    maxHeight: 200.0,
                                                                                    searchHintTextStyle: FlutterFlowTheme.of(context).labelSmall.override(
                                                                                          fontFamily: FlutterFlowTheme.of(context).labelSmallFamily,
                                                                          ...
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Align(
                                                                                alignment: AlignmentDirectional(0.0, 0.0),
                                                                                child: FlutterFlowDropDown<String>(
                                                                                  controller: _model.dropDownMakeValueController7 ??= FormFieldController<String>(
                                                                                    _model.dropDownMakeValue7 ??= '',
                                                                                  ),
                                                                                  options: List<String>.from(<String>[]),
                                                                                  optionLabels: <String>[],
                                                                                  onChanged: (val) => safeSetState(() => _model.dropDownMakeValue7 = val),
                                                                                  height: 24.5,
                                                                                  maxHeight: 200.0,
                                                                                  searchHintTextStyle: FlutterFlowTheme.of(context).labelSmall.override(
                                                                                        fontFamily: FlutterFlowTheme.of(context).labelSmallFamily,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          Row(
                                                                            ...
                                                                            ].divide(SizedBox(width: 1.0)).addToStart(SizedBox(width: 24.0)),
                                                                          ),
                                                                        ].divide(SizedBox(height: 4.0)),
                                                                      ),
                                                                    ),
                                                                          ...
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Align(
                                                                                alignment: AlignmentDirectional(0.0, 0.0),
                                                                                child: FlutterFlowDropDown<String>(
                                                                                  controller: _model.dropDownMakeValueController8 ??= FormFieldController<String>(
                                                                                    _model.dropDownMakeValue8 ??= '',
                                                                                  ),
                                                                                  options: List<String>.from(<String>[]),
                                                                                  optionLabels: <String>[],
                                                                                  onChanged: (val) => safeSetState(() => _model.dropDownMakeValue8 = val),
                                                                                  height: 24.5,
                                                                                  maxHeight: 200.0,
                                                                                  searchHintTextStyle: FlutterFlowTheme.of(context).labelSmall.override(
                                                                                        fontFamily: FlutterFlowTheme.of(context).labelSmallFamily,
